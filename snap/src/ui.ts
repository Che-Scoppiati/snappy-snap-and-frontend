...
export async function createMenuInterface(): Promise<string> {
  return await snap.request({
    ...
    params: {
      ui: panel([
        heading(" Gm, I'm Snappy! How can I help you?"),
        text(
          "I'm your **AI assistant** inside Metamask. Ask me for a transaction you want to perform or for information!"
        ),
        text(
          "**Stop wasting time** looking for the right Dapp or for Web3 information. Ask me!"
        ),
        ...
        divider(),
        text(
          "(if you find any bugs, please report them to [Che Scoppiati](https://github.com/Che-Scoppiati) team 🤯)"
        ),
        text("Powered by BrianAI 🧠 & Zerion 🔵"),
      ]),
    },
  });
}
